...
{
	if (region.b5.ag === region.cl.ag)
	{
		return 'on line ' + region.b5.ag;
	}
	return 'on lines ' + region.b5.ag + ' through ' + region.cl.ag;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dc: 'hidden', c4: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dc: 'mozHidden', c4: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dc: 'msHidden', c4: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dc: 'webkitHidden', c4: 'webkitvisibilitychange' }
		: { dc: 'hidden', c4: 'visibilitychange' };
}
...
var $author$project$Main$init = {W: $rundis$elm_bootstrap$Bootstrap$Accordion$initialState};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cn: fragment, cp: host, cC: path, cE: port_, cI: protocol, cJ: query};
	});
...
var $elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			dg: function (_v0) {
				return _Utils_Tuple2(impl.dg, $elm$core$Platform$Cmd$none);
			},
			dp: function (_v1) {
...
var $author$project$Main$AccordionMsg = $elm$core$Basics$identity;
...
var $rundis$elm_bootstrap$Bootstrap$Accordion$config = function (toMsg) {
	return {aK: _List_Nil, aj: false, ca: toMsg, K: false};
};
...
var $author$project$Main$hyperlink = F3(
	function (attr, link, inner) {
		return A2(
			$elm$html$Html$a,
			_Utils_ap(
				_List_fromArray(
...
var $rundis$elm_bootstrap$Bootstrap$Card$Internal$defaultBlockOptions = {t: $elm$core$Maybe$Nothing, aG: _List_Nil, v: $elm$core$Maybe$Nothing, z: $elm$core$Maybe$Nothing};
...
var $rundis$elm_bootstrap$Bootstrap$Accordion$card = function (rec) {
	return {c2: rec.c2, da: rec.da, de: rec.de, dm: rec.dm};
};
...
var $rundis$elm_bootstrap$Bootstrap$Accordion$headerPrivate = F3(
	function (elemFn, attributes, toggle_) {
		return {aG: attributes, aN: _List_Nil, aO: _List_Nil, ck: elemFn, cT: toggle_};
	});
...
var $rundis$elm_bootstrap$Bootstrap$Accordion$toggle = F2(
	function (attributes, children) {
		return {aG: attributes, cg: children};
	});
var $author$project$Main$simpleCard = F3(
	function (id, txt, inner) {
		return $rundis$elm_bootstrap$Bootstrap$Accordion$card(
			{
				c2: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($rundis$elm_bootstrap$Bootstrap$Card$Block$text, _List_Nil, inner)
							]))
					]),
				da: A2(
...
var $rundis$elm_bootstrap$Bootstrap$Card$Internal$defaultOptions = {t: $elm$core$Maybe$Nothing, aG: _List_Nil, v: $elm$core$Maybe$Nothing, z: $elm$core$Maybe$Nothing};
...
var $rundis$elm_bootstrap$Bootstrap$Accordion$animationAttributes = F3(
	function (state, configRec, _v0) {
		var id = _v0.de;
		var styles = $rundis$elm_bootstrap$Bootstrap$Accordion$transitionStyle(configRec.K);
				...
				F2(
					function (i, c) {
						return _Utils_eq(i, id) ? {
							co: $elm$core$Maybe$Just(h),
							f: A2($rundis$elm_bootstrap$Bootstrap$Accordion$visibilityTransition, configRec.K, c.f)
						} : (((c.f === 3) && (configRec.K && configRec.aj)) ? _Utils_update(
							c,
							{f: 2}) : (((c.f === 3) && ((!configRec.K) && configRec.aj)) ? _Utils_update(
							c,
							{f: 0}) : c));
					}),
				initStates);
...
var $rundis$elm_bootstrap$Bootstrap$Accordion$renderToggle = F3(
	function (state, configRec, card_) {
		...
		var _v0 = cardRec.da;
		var headerRec = _v0;
		var _v1 = headerRec.cT;
		var attributes = _v1.aG;
		var children = _v1.cg;
		return A2(
...
var $author$project$Main$cards = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					A3(
					$author$project$Main$simpleCard,
					'card1',
					'Oshi',
					_List_fromArray(
						[
							...
							_List_Nil,
							'https://www.youtube.com/watch?v=jK5BcSYh70s',
							_List_fromArray(
								[
									$elm$html$Html$text('Takanashi Kiwawa')
								]))
						])),
					A3(
					$author$project$Main$simpleCard,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('https://www.youtube.com/watch?v=dQw4w9WgXcQ')
								]))
						])),
					A3(
					$author$project$Main$simpleCard,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('King Gizzard and the Lizard Wizzard')
								]))
						]))
				]),
			$rundis$elm_bootstrap$Bootstrap$Accordion$withAnimation(
				$rundis$elm_bootstrap$Bootstrap$Accordion$config($elm$core$Basics$identity))));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$text('I\'m Ivan Pineda lmao'),
				$author$project$Main$cards(model)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{dg: $author$project$Main$init, dr: $author$project$Main$update, ds: $author$project$Main$view});
